...
import {SignUpInput} from '@kartik_chausali/common/dist'
...
export const Auth = ({type}: {type : "signup" | "signin"})=>{
    ...
    async function sendRequest(){
        try{
            ...
            navigate(`/landing/${response.data.userId}`)
    ...
    return <div className="flex flex-col justify-center md:h-screen">
        <div className="flex justify-center ">
            ...
            <div className="text-slate-400">
                ...
                <Link to={type === 'signup' ? '/signin' : '/'} className="pl-2 underline">{type === 'signup'? "Login" : "Signup"}</Link>
            </div>
            </div>
